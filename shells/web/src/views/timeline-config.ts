...
export const PANEL_SHORTCUTS: PanelShortcut[] = [
  ...
  { keys: 'Shift + D', label: t('Detach audio'), events: [{ key: 'D', shiftKey: true }] },
  {
    keys: 'Shift + O',
    label: t('Onion skin'),
    events: [{ key: 'O', shiftKey: true }],
  },
  { keys: 'Alt + Shift + O', label: t('Onion skin options'), events: [{ key: 'O', altKey: true, shiftKey: true }] },
  { keys: 'J K L', label: t('Shuttle backward, stop or forward'), events: [{ key: 'j' }, { key: 'k' }, { key: 'l' }] },
  { keys: 'I O', label: t('Set in or out point'), events: [{ key: 'i' }, { key: 'o' }] },
  { keys: 'M', label: t('Add marker'), events: [{ key: 'm' }] },
  { keys: 'Shift + M', label: t('Edit marker'), events: [{ key: 'M', shiftKey: true }] },
  { keys: 'Ctrl + ← →', label: t('Previous or next marker'), events: [{ key: 'ArrowLeft', ctrlKey: true }, { key: 'ArrowRight', ctrlKey: true }] },
