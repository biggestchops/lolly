...
<!-- web-src-dirs:start -->
Roughly 543,000 lines of TypeScript, tests included, and 48,000 lines of CSS.

| Directory | Source | Tests | CSS |
|---|---|---|---|
| `views/` | 306 files, 150,837 lines | 150 files, 55,407 lines | 4 files, 735 lines |
...
| `styles/` | none | 4 files, 857 lines | 82 files, 43,189 lines |

Plus 46 `.ts`/`.js` files at the top level of `src/`, 15,369 lines all told, of which 21 are tests and 3 are ambient declarations. `main.ts` is 2,075 of that.
<!-- web-src-dirs:end -->
