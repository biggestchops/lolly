...
| `lib/` | 561 files, 126,222 lines | 321 files, 62,720 lines | 11 files, 1,780 lines |
| `bridge/` | 143 files, 46,931 lines | 97 files, 21,166 lines | none |
...
| 3,215 | `bridge/sequence-render.ts` | yes |
...
| 2,185 | `views/free-canvas.ts` | yes, nine `free-canvas-*.test.ts` files |
| 2,170 | `views/design-inspector.ts` | yes |
| 2,123 | `main.ts` | yes |
